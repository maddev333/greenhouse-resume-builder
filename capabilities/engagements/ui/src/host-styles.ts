/**
 * MCP App style variables (reproduced from the ext-apps basic-host reference).
 * Passed to embedded apps via hostContext.styles.variables so the sandboxed ui://trip-map
 * App inherits consistent theming through CSS custom properties.
 */
