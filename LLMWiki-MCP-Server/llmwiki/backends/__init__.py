...
from .base import WikiStorage, create_sqlite_backend, create_azure_backend

__all__ = ["WikiStorage", "create_backend", "create_sqlite_backend", "create_azure_backend"]


def create_backend(storage_mode: str | None = None) -> WikiStorage:
    """Select and return the appropriate backend implementation."""
    _env = storage_mode or "auto"
    if _env == "azure":
