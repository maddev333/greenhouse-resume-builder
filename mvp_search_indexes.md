...
Azure Maps does not need a dedicated source-of-truth container. The API can project map pins from Cosmos DB and/or Azure AI Search records that include location metadata.
